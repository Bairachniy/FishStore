...
namespace FishStore.Domain.Concrete
{
    public class EmailSettings
    {
        ...
        public string MailFromAddress = "fishstore@example.com";
        ...
        public string FileLocation = @"c:\Fish_store_emails";
    }
    public class EmailOrderProcessor : IOrderProcessor
    {
        ...
        public void ProcessOrder(Cart cart, ShippingDetails shippingInfo)
        {
            using (var smtpClient = new SmtpClient())
            {
                ...
                {
                    var subtotal = line.Fish.Price * line.Quantity;
                    body.AppendFormat("{0} x {1} (итого: {2:c}",
                        line.Quantity, line.Fish.Name, subtotal);
                }
