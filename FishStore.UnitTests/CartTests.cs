...
namespace FishStore.UnitTests
{
    ...
    public class CartTests
    {
        ...
        public void Can_Add_New_Lines()
        {
            ...
            Fish Fish1 = new Fish { FishId = 1, Name = "Игра1" };
            Fish Fish2 = new Fish { FishId = 2, Name = "Игра2" };

            // Организация - создание корзины
            Cart cart = new Cart();

            // Действие
            cart.AddItem(Fish1, 1);
            cart.AddItem(Fish2, 1);
            List<CartLine> results = cart.Lines.ToList();

            // Утверждение
            Assert.AreEqual(results.Count(), 2);
            Assert.AreEqual(results[0].Fish, Fish1);
            Assert.AreEqual(results[1].Fish, Fish2);
        }
        [TestMethod]
        public void Can_Add_Quantity_For_Existing_Lines()
        {
            ...
            cart.AddItem(Fish1, 1);
            cart.AddItem(Fish2, 1);
            cart.AddItem(Fish1, 5);
            List<CartLine> results = cart.Lines.OrderBy(c => c.Fish.FishId).ToList();
        ...
        public void Can_Remove_Line()
        {
            ...
            Fish Fish1 = new Fish { FishId = 1, Name = "Игра1" };
            Fish Fish2 = new Fish { FishId = 2, Name = "Игра2" };
            Fish Fish3 = new Fish { FishId = 3, Name = "Игра3" };
            ...
            cart.AddItem(Fish1, 1);
            cart.AddItem(Fish2, 4);
            cart.AddItem(Fish3, 2);
            cart.AddItem(Fish2, 1);

            // Действие
            cart.RemoveLine(Fish2);

            // Утверждение
            Assert.AreEqual(cart.Lines.Where(c => c.Fish == Fish2).Count(), 0);
        ...
        {
            // Организация - создание нескольких тестовых игр
            Fish Fish1 = new Fish { FishId = 1, Name = "Игра1", Price = 100 };
            Fish Fish2 = new Fish { FishId = 2, Name = "Игра2", Price = 55 };
        ...
        new Fish {FishId = 1, Name = "Игра1", Category = "Кат1"},
    }.AsQueryable());
            ...
            Assert.AreEqual(cart.Lines.ToList()[0].Fish.FishId, 1);
        }
        ...
        /// </summary>
        [TestMethod]
        public void Adding_Fish_To_Cart_Goes_To_Cart_Screen()
        {
            // Организация - создание имитированного хранилища
            Mock<IFishRepository> mock = new Mock<IFishRepository>();
            mock.Setup(m => m.Fishes).Returns(new List<Fish> {
